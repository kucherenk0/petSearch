...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './picture.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PICTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PICTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PICTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PICTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PICTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PICTURE actions', async () => {
      const expectedActions = [
        {
