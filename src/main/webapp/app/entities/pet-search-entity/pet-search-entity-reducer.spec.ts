...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PETSEARCHENTITY_LIST actions', async () => {
    ...
    it('dispatches CREATE_PETSEARCHENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PETSEARCHENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PETSEARCHENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PETSEARCHENTITY actions', async () => {
      const expectedActions = [
        {
