	...
	return (
		<div>
			<div className={'photoFormTitle'}>
				...
				<Description>
					<p>
						Если ваша собака потерялась, то в форме ниже укажите ее цвет,
						длину хвоста, а также опционально предполагаемую дату и адрес
						потери , радиус поиска в километрах, породу собаки. Сервис выдаст
						вам фотографии с московских камер видеонаблюдения, где есть
						похожие собаки, с адресом, временем съемки и породой собаки.
					</p>
				</Description>
			</div>
			{lastDate && (
			...
			<main className={'searchFormMain'}>
				...
				<DogResults isLoading={isLoading} results={results} limitElements={20} />
			</main>
		</div>
	);
};
