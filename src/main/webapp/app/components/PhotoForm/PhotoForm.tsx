	...
	return (
		<div className={'photoFormContainer'}>
			<div className={'photoFormTitle'}>
				...
				<Description>
					<p>
						Ниже загрузите фотографии с камер видеонаблюдения для обновления
						базы поиска. После нагрузки сервис покажет параметры каждого
						кадра: есть ли животное на фото, есть ли собака на фото, ее
						хозяин, цвет, длину хвоста, а также адрес, дату, время и
